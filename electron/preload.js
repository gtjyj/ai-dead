...
contextBridge.exposeInMainWorld('monitorApi', {
  ...
  deleteRemoteMachine: machineId => ipcRenderer.invoke('monitor:delete-remote-machine', machineId),
  ...
  restoreRemoteMachinesGist: settings => ipcRenderer.invoke('monitor:restore-remote-machines-gist', settings),
  saveApi: payload => ipcRenderer.invoke('monitor:save-api', payload),
  saveRemoteMachine: payload => ipcRenderer.invoke('monitor:save-remote-machine', payload),
  ...
  syncRemoteMachinesGist: settings => ipcRenderer.invoke('monitor:sync-remote-machines-gist', settings),
